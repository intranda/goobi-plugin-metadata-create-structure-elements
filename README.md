# Goobi workflow Plugin: goobi-plugin-metadataeditor-createStructureElements

<img src="https://goobi.io/wp-content/uploads/logo_goobi_plugin.png" align="right" style="margin:0 0 20px 20px;" alt="Plugin for Goobi workflow" width="175" height="109">

This is the CreateStructureElements Goobi step plugin. A description for this plugin is still missing.
...
Detail | Description
--- | ---
**Plugin identifier**       | intranda_step_createStructureElements
